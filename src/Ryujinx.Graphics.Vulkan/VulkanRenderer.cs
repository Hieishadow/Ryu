...
namespace Ryujinx.Graphics.Vulkan
{
    public sealed class VulkanRenderer : IRenderer
    {
        ...
        public static VulkanRenderer Create(string preferredGpuId, Func<Instance, Vk, SurfaceKHR> getSurface, Func<string[]> getRequiredExtensions) => new(Vk.GetApi(), getSurface, getRequiredExtensions, preferredGpuId);
        ...
        private unsafe void LoadFeatures(uint maxQueueCount, uint queueFamilyIndex)
        {
            ...
            if (Api.TryGetDeviceExtension(_instance.Instance, _device, out ExtConditionalRendering conditionalRenderingApi)) ConditionalRenderingApi = conditionalRenderingApi;
            if (Api.TryGetDeviceExtension(_instance.Instance, _device, out ExtExtendedDynamicState extendedDynamicStateApi)) ExtendedDynamicStateApi = extendedDynamicStateApi;
            if (Api.TryGetDeviceExtension(_instance.Instance, _device, out KhrPushDescriptor pushDescriptorApi)) PushDescriptorApi = pushDescriptorApi;
            if (Api.TryGetDeviceExtension(_instance.Instance, _device, out ExtTransformFeedback transformFeedbackApi)) TransformFeedbackApi = transformFeedbackApi;
            if (Api.TryGetDeviceExtension(_instance.Instance, _device, out KhrDrawIndirectCount drawIndirectCountApi)) DrawIndirectCountApi = drawIndirectCountApi;
            if (Api.TryGetDeviceExtension(_instance.Instance, _device, out ExtAttachmentFeedbackLoopDynamicState dynamicFeedbackLoopApi)) DynamicFeedbackLoopApi = dynamicFeedbackLoopApi;
            if (maxQueueCount >= 2)
            {
            ...
            PhysicalDeviceIDProperties propertiesId = new() { SType = StructureType.PhysicalDeviceIDProperties, PNext = properties2.PNext };
            properties2.PNext = &propertiesId;
            PhysicalDeviceSubgroupProperties propertiesSubgroup = new() { SType = StructureType.PhysicalDeviceSubgroupProperties, PNext = properties2.PNext };
            properties2.PNext = &propertiesSubgroup;
            PhysicalDeviceBlendOperationAdvancedPropertiesEXT propertiesBlendOperationAdvanced = new() { SType = StructureType.PhysicalDeviceBlendOperationAdvancedPropertiesExt };
            bool supportsBlendOperationAdvanced = _physicalDevice.IsDeviceExtensionPresent("VK_EXT_blend_operation_advanced");
            if (supportsBlendOperationAdvanced) { propertiesBlendOperationAdvanced.PNext = properties2.PNext; properties2.PNext = &propertiesBlendOperationAdvanced; }
            bool supportsTransformFeedback = _physicalDevice.IsDeviceExtensionPresent(ExtTransformFeedback.ExtensionName);
            PhysicalDeviceTransformFeedbackPropertiesEXT propertiesTransformFeedback = new() { SType = StructureType.PhysicalDeviceTransformFeedbackPropertiesExt };
            if (supportsTransformFeedback) { propertiesTransformFeedback.PNext = properties2.PNext; properties2.PNext = &propertiesTransformFeedback; }
            PhysicalDevicePortabilitySubsetPropertiesKHR propertiesPortabilitySubset = new() { SType = StructureType.PhysicalDevicePortabilitySubsetPropertiesKhr };
            bool supportsPushDescriptors = _physicalDevice.IsDeviceExtensionPresent(KhrPushDescriptor.ExtensionName);
            PhysicalDevicePushDescriptorPropertiesKHR propertiesPushDescriptor = new() { SType = StructureType.PhysicalDevicePushDescriptorPropertiesKhr };
            if (supportsPushDescriptors) { propertiesPushDescriptor.PNext = properties2.PNext; properties2.PNext = &propertiesPushDescriptor; }
            PhysicalDeviceFeatures2 features2 = new() { SType = StructureType.PhysicalDeviceFeatures2 };
            PhysicalDevicePrimitiveTopologyListRestartFeaturesEXT featuresPrimitiveTopologyListRestart = new() { SType = StructureType.PhysicalDevicePrimitiveTopologyListRestartFeaturesExt };
            PhysicalDeviceRobustness2FeaturesEXT featuresRobustness2 = new() { SType = StructureType.PhysicalDeviceRobustness2FeaturesExt };
            PhysicalDeviceShaderFloat16Int8FeaturesKHR featuresShaderInt8 = new() { SType = StructureType.PhysicalDeviceShaderFloat16Int8Features };
            PhysicalDeviceCustomBorderColorFeaturesEXT featuresCustomBorderColor = new() { SType = StructureType.PhysicalDeviceCustomBorderColorFeaturesExt };
            PhysicalDeviceDepthClipControlFeaturesEXT featuresDepthClipControl = new() { SType = StructureType.PhysicalDeviceDepthClipControlFeaturesExt };
            PhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT featuresAttachmentFeedbackLoop = new() { SType = StructureType.PhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesExt };
            PhysicalDeviceAttachmentFeedbackLoopDynamicStateFeaturesEXT featuresDynamicAttachmentFeedbackLoop = new() { SType = StructureType.PhysicalDeviceAttachmentFeedbackLoopDynamicStateFeaturesExt };
            PhysicalDevicePortabilitySubsetFeaturesKHR featuresPortabilitySubset = new() { SType = StructureType.PhysicalDevicePortabilitySubsetFeaturesKhr };
            if (_physicalDevice.IsDeviceExtensionPresent("VK_EXT_primitive_topology_list_restart")) features2.PNext = &featuresPrimitiveTopologyListRestart;
            if (_physicalDevice.IsDeviceExtensionPresent("VK_EXT_robustness2")) { featuresRobustness2.PNext = features2.PNext; features2.PNext = &featuresRobustness2; }
            if (_physicalDevice.IsDeviceExtensionPresent("VK_KHR_shader_float16_int8")) { featuresShaderInt8.PNext = features2.PNext; features2.PNext = &featuresShaderInt8; }
            if (_physicalDevice.IsDeviceExtensionPresent("VK_EXT_custom_border_color")) { featuresCustomBorderColor.PNext = features2.PNext; features2.PNext = &featuresCustomBorderColor; }
            bool supportsDepthClipControl = _physicalDevice.IsDeviceExtensionPresent("VK_EXT_depth_clip_control");
            if (supportsDepthClipControl) { featuresDepthClipControl.PNext = features2.PNext; features2.PNext = &featuresDepthClipControl; }
            bool supportsAttachmentFeedbackLoop = _physicalDevice.IsDeviceExtensionPresent("VK_EXT_attachment_feedback_loop_layout");
            if (supportsAttachmentFeedbackLoop) { featuresAttachmentFeedbackLoop.PNext = features2.PNext; features2.PNext = &featuresAttachmentFeedbackLoop; }
            ...
            if (supportsDynamicAttachmentFeedbackLoop) { featuresDynamicAttachmentFeedbackLoop.PNext = features2.PNext; features2.PNext = &featuresDynamicAttachmentFeedbackLoop; }
        ...
        public BufferHandle CreateBuffer(int size, BufferAccess access) => BufferManager.CreateWithHandle(this, size, access.HasFlag(BufferAccess.SparseCompatible), access.Convert(), access.HasFlag(BufferAccess.Stream));
        public BufferHandle CreateBuffer(nint pointer, int size) => BufferManager.CreateHostImported(this, pointer, size);
        public BufferHandle CreateBufferSparse(ReadOnlySpan<BufferRange> storageBuffers) => BufferManager.CreateSparse(this, storageBuffers);
        public IImageArray CreateImageArray(int size, bool isBuffer) => new ImageArray(this, size, isBuffer);
        ...
        public ISampler CreateSampler(SamplerCreateInfo info) => new SamplerHolder(this, _device, info);
        public ITexture CreateTexture(TextureCreateInfo info) { if (info.Target == Target.TextureBuffer) return new TextureBuffer(this, info); return CreateTextureView(info); }
        public ITextureArray CreateTextureArray(int size, bool isBuffer) => new TextureArray(this, size, isBuffer);
        internal TextureView CreateTextureView(TextureCreateInfo info) { TextureStorage storage = CreateTextureStorage(info); return storage.CreateView(info, 0, 0); }
        internal TextureStorage CreateTextureStorage(TextureCreateInfo info) => new TextureStorage(this, _device, info);
        public void DeleteBuffer(BufferHandle buffer) => BufferManager.Delete(buffer);
        internal void FlushAllCommands() => _pipeline?.FlushCommandsImpl();
        ...
        public unsafe Capabilities GetCapabilities() {
            ...
            bool supportsEtc2CompressionFormat = FormatCapabilities.OptimalFormatsSupport(compressedFormatFeatureFlags, Format.Etc2RgbaSrgb, Format.Etc2RgbaUnorm, Format.Etc2RgbPtaSrgb, Format.Etc2RgbPtaUnorm, Format.Etc2RgbSrgb, Format.Etc2RgbUnorm);
            bool supports5BitComponentFormat = FormatCapabilities.OptimalFormatsSupport(compressedFormatFeatureFlags, Format.R5G6B5Unorm, Format.R5G5B5A1Unorm, Format.R5G5B5X1Unorm, Format.B5G6R5Unorm, Format.B5G5R5A1Unorm, Format.A1B5G5R5Unorm);
            bool supportsR4G4B4A4Format = FormatCapabilities.OptimalFormatsSupport(compressedFormatFeatureFlags, Format.R4G4B4A4Unorm);
            bool supportsAstcFormats = FormatCapabilities.OptimalFormatsSupport(compressedFormatFeatureFlags, Format.Astc4x4Unorm, Format.Astc5x4Unorm, Format.Astc5x5Unorm, Format.Astc6x5Unorm, Format.Astc6x6Unorm, Format.Astc8x5Unorm, Format.Astc8x6Unorm, Format.Astc8x8Unorm, Format.Astc10x5Unorm, Format.Astc10x6Unorm, Format.Astc10x8Unorm, Format.Astc10x10Unorm, Format.Astc12x10Unorm, Format.Astc12x12Unorm, Format.Astc4x4Srgb, Format.Astc5x4Srgb, Format.Astc5x5Srgb, Format.Astc6x5Srgb, Format.Astc6x6Srgb, Format.Astc8x5Srgb, Format.Astc8x6Srgb, Format.Astc8x8Srgb, Format.Astc10x5Srgb, Format.Astc10x6Srgb, Format.Astc10x8Srgb, Format.Astc10x10Srgb, Format.Astc12x10Srgb, Format.Astc12x12Srgb);
            PhysicalDeviceVulkan12Features featuresVk12 = new() { SType = StructureType.PhysicalDeviceVulkan12Features };
            PhysicalDeviceFeatures2 features2 = new() { SType = StructureType.PhysicalDeviceFeatures2, PNext = &featuresVk12 };
            Api.GetPhysicalDeviceFeatures2(_physicalDevice.PhysicalDevice, &features2);
