...
public class GameActivity : Activity
{
    ...
    void EmulationLoop()
    {
        try{
            ...
            LogAppend("Vulkan OK"); var audio=new DummyHardwareDeviceDriver(); var hleConf=BuildHleConfigurationFIX(vfs,gpu,audio); LogAppend("HLE Config OK");
            LogAppend("Criando Switch..."); device=new Switch(hleConf); LogAppend("Switch criado"); if(!device.LoadNsp(romPath)) throw new Exception("LoadNsp false"); LogAppend("NSP OK");
    ...
    // SEU METODO ORIGINAL QUE COMPILA NO HIEISHADOW + FIX DO null!
