...
namespace Ryujinx.Android
{
    ...
    public class MainActivity : Activity
    {
        ...
        void Carregar() {
            ...
            lista.AddView(new TextView(this){ Text=$"Keys: {(File.Exists(key)?"OK":"FALTA")} | Firmware: {(hasFw?"OK":"FALTA")}\n" });
            ...
            try {
                ...
                lista.AddView(new TextView(this){ Text=$"\nUpdates/DLC ({updates.Length+dlcs.Length}):" });
                foreach(var f in updates.Concat(dlcs)) lista.AddView(new TextView(this){ Text=" - "+Path.GetFileName(f), TextSize=11f });
            } catch (System.Exception ex) { lista.AddView(new TextView(this){ Text="Erro: "+ex.Message }); }
        }

        void Bootar(string path) {
            var i = new global::Android.Content.Intent(this, typeof(GameActivity));
    ...
    [Activity(Label = "Game", ScreenOrientation = global::Android.Content.PM.ScreenOrientation.Landscape, ConfigurationChanges = global::Android.Content.PM.ConfigChanges.Orientation | global::Android.Content.PM.ConfigChanges.KeyboardHidden | global::Android.Content.PM.ConfigChanges.ScreenSize)]
    public class GameActivity : Activity
    {
        protected override void OnCreate(Bundle? b)
        {
            ...
            SetContentView(new TextView(this){ Text=$"Fafnir V6 Bootando\n{Path.GetFileName(game)}\n\nPronto pra V7 Vulkan!", TextSize=14f });
        }
    }
}
